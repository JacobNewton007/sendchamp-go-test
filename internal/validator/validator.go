...
// use this later in the book). If you're interested, this regular expression pattern is // taken from https://html.spec.whatwg.org/#valid-e-mail-address. Note: if you're
...
// New is a helper which creates a validator instance with an empty errors map
func New() *Validator {
